<template>
    <div class="fx-doc-demo-block">
        <h2 v-if="title" class="fx-doc-demo-block__title" :id="slugifyTitle">
            {{ title }}
        </h2>
        <div v-if="card" class="fx-doc-demo-block__card">
            <slot />
        </div>
        <slot v-else />
    </div>
