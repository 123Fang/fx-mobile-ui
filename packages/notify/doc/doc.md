...
import { Notify } from 'cft-ics-mobile-ui';
...
```js
import { showNotify } from 'cft-ics-mobile-ui';
...
```js
import { showNotify, closeNotify } from 'cft-ics-mobile-ui';
