...
```html
<fx-floating-panel :anchors="[100, 200, 300]" :magnetic="false">
  <div style="text-align: center; padding: 15px">
    <p>已禁用磁力吸附</p>
    <p>面板可在边界范围内任意位置停留</p>
  </div>
...
| ---------------------------------- | ------------------------- | ----------- |
| --fx-floating-panel-border-radius | _16px_                    | -           |
| --fx-floating-panel-header-height | _30px_                    | -           |
| --fx-floating-panel-z-index       | _999_                     | -           |
| --fx-floating-panel-background    | _var(--fx-background-2)_ | -           |
| --fx-floating-panel-bar-width     | _20px_                    | -           |
| --fx-floating-panel-bar-height    | _3px_                     | -           |
| --fx-floating-panel-bar-color     | _var(--fx-gray-5)_       | -           |
