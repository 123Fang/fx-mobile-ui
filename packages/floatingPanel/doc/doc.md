...
import { FloatingPanel } from 'cft-ics-mobile-ui';
...
```html
<icsm-floating-panel :anchors="[100, 200, 300]" :magnetic="false">
  <div style="text-align: center; padding: 15px">
    <p>已禁用磁力吸附</p>
    <p>面板可在边界范围内任意位置停留</p>
  </div>
...
```ts
import type { FloatingPanelProps } from 'cft-ics-mobile-ui';
```
...
| ---------------------------------- | ------------------------- | ----------- |
| --icsm-floating-panel-border-radius | _16px_                    | -           |
| --icsm-floating-panel-header-height | _30px_                    | -           |
| --icsm-floating-panel-z-index       | _999_                     | -           |
| --icsm-floating-panel-background    | _var(--icsm-background-2)_ | -           |
| --icsm-floating-panel-bar-width     | _20px_                    | -           |
| --icsm-floating-panel-bar-height    | _3px_                     | -           |
| --icsm-floating-panel-bar-color     | _var(--icsm-gray-5)_       | -           |
