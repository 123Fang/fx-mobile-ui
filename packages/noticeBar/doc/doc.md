...
import { NoticeBar } from 'cft-ics-mobile-ui';
...
```ts
import type { NoticeBarMode, NoticeBarProps, NoticeBarInstance } from 'cft-ics-mobile-ui';
```
...
```ts
import { ref } from 'vue';
import type { NoticeBarInstance } from 'cft-ics-mobile-ui';
