...
import { Swipe, SwipeItem } from 'fx-mobile-ui';
...
```html
<fx-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
...
```html
<fx-swipe style="height: 200px;" vertical>
  <fx-swipe-item>1</fx-swipe-item>
  <fx-swipe-item>2</fx-swipe-item>
  <fx-swipe-item>3</fx-swipe-item>
  <fx-swipe-item>4</fx-swipe-item>
...
```ts
import type { SwipeProps, SwipeInstance, SwipeToOptions } from 'fx-mobile-ui';
```
...
```ts
import { ref } from 'vue';
import type { SwipeInstance } from 'fx-mobile-ui';
...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --fx-swipe-indicator-size | _6px_ | - |
| --fx-swipe-indicator-margin | _var(--fx-padding-sm)_ | - |
| --fx-swipe-indicator-active-opacity | _1_ | - |
| --fx-swipe-indicator-inactive-opacity | _0.3_ | - |
| --fx-swipe-indicator-active-background | _var(--fx-primary-color)_ | - |
| --fx-swipe-indicator-inactive-background | _var(--fx-border-color)_ | - |
...
```html
<fx-swipe v-show="show" ref="swipe" />
```
