...
import { Swipe, SwipeItem } from 'ctf-ics-mobile-ui';
...
```html
<icsm-swipe style="height: 200px;" vertical>
  <icsm-swipe-item>1</icsm-swipe-item>
  <icsm-swipe-item>2</icsm-swipe-item>
  <icsm-swipe-item>3</icsm-swipe-item>
  <icsm-swipe-item>4</icsm-swipe-item>
...
```html
<icsm-swipe :loop="false" :width="300">
  <icsm-swipe-item>1</icsm-swipe-item>
  <icsm-swipe-item>2</icsm-swipe-item>
  <icsm-swipe-item>3</icsm-swipe-item>
  <icsm-swipe-item>4</icsm-swipe-item>
...
```ts
import type { SwipeProps, SwipeInstance, SwipeToOptions } from 'ctf-ics-mobile-ui';
```
...
```ts
import { ref } from 'vue';
import type { SwipeInstance } from 'ctf-ics-mobile-ui';
...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --icsm-swipe-indicator-size | _6px_ | - |
| --icsm-swipe-indicator-margin | _var(--icsm-padding-sm)_ | - |
| --icsm-swipe-indicator-active-opacity | _1_ | - |
| --icsm-swipe-indicator-inactive-opacity | _0.3_ | - |
| --icsm-swipe-indicator-active-background | _var(--icsm-primary-color)_ | - |
| --icsm-swipe-indicator-inactive-background | _var(--icsm-border-color)_ | - |
...
```html
<!-- Before -->
<icsm-swipe v-show="show" />
<!-- After -->
<icsm-swipe v-if="show" />
```

方法二，调用组件的 resize 方法来主动触发重绘：

```html
<icsm-swipe v-show="show" ref="swipe" />
```
