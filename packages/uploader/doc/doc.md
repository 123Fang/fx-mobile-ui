...
import { Uploader } from 'ctf-ics-mobile-ui';
...
```html
<icsm-uploader v-model="fileList" multiple />
```
...
```html
<icsm-uploader v-model="fileList" :after-read="afterRead" />
```
...
```html
<icsm-uploader v-model="fileList" multiple :max-count="2" />
```
...
```html
<icsm-uploader multiple :max-size="500 * 1024" @oversize="onOversize" />
```
...
```html
<icsm-uploader multiple :max-size="isOverSize" />
```
...
```html
<icsm-uploader>
  <icsm-button icon="plus" type="primary">上传文件</icsm-button>
</icsm-uploader>
```
...
```html
<icsm-uploader v-model="fileList">
...
```html
<!-- 不指定单位，默认为 px -->
<icsm-uploader v-model="fileList" preview-size="60" />
<!-- 指定单位，支持 rem, vh, vw -->
<icsm-uploader v-model="fileList" preview-size="5rem" />
```

将 `preview-size` 设置为数组格式，可以分别设置宽高。数组第一项对应宽度，数组第二项对应高度。

```html
<icsm-uploader v-model="fileList" :preview-size="[60, 40]" />
```
...
```html
<icsm-uploader :before-read="beforeRead" />
```
...
```html
<icsm-uploader v-model="fileList" :deletable="false" />
```
...
```html
<icsm-uploader v-model="fileList" reupload max-count="2" />
```
...
```ts
import { ref } from 'vue';
import type { UploaderInstance } from 'ctf-ics-mobile-ui';
...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --icsm-uploader-size | _80px_ | - |
| --icsm-uploader-icon-size | _24px_ | - |
| --icsm-uploader-icon-color | _var(--icsm-gray-4)_ | - |
| --icsm-uploader-text-color | _var(--icsm-text-color-2)_ | - |
| --icsm-uploader-text-font-size | _var(--icsm-font-size-sm)_ | - |
| --icsm-uploader-upload-background | _var(--icsm-gray-1)_ | - |
| --icsm-uploader-upload-active-color | _var(--icsm-active-color)_ | - |
| --icsm-uploader-delete-color | _var(--icsm-white)_ | - |
| --icsm-uploader-delete-icon-size | _14px_ | - |
| --icsm-uploader-delete-background | _rgba(0, 0, 0, 0.7)_ | - |
| --icsm-uploader-file-background | _var(--icsm-background)_ | - |
| --icsm-uploader-file-icon-size | _20px_ | - |
| --icsm-uploader-file-icon-color | _var(--icsm-gray-7)_ | - |
| --icsm-uploader-file-name-padding | _0 var(--icsm-padding-base)_ | - |
| --icsm-uploader-file-name-margin-top | _var(--icsm-padding-xs)_ | - |
| --icsm-uploader-file-name-font-size | _var(--icsm-font-size-sm)_ | - |
| --icsm-uploader-file-name-text-color | _var(--icsm-gray-7)_ | - |
| --icsm-uploader-mask-text-color | _var(--icsm-white)_ | - |
| --icsm-uploader-mask-background | _fade(var(--icsm-gray-8), 88%)_ | - |
| --icsm-uploader-mask-icon-size | _22px_ | - |
| --icsm-uploader-mask-message-font-size | _var(--icsm-font-size-sm)_ | - |
| --icsm-uploader-mask-message-line-height | _var(--icsm-line-height-xs)_ | - |
| --icsm-uploader-loading-icon-size | _22px_ | - |
| --icsm-uploader-loading-icon-color | _var(--icsm-white)_ | - |
| --icsm-uploader-disabled-opacity | _var(--icsm-disabled-opacity)_ | - |
| --icsm-uploader-border-radius | _0px_ | - |
