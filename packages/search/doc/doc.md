...
import { Search } from 'fx-mobile-ui';
...
```html
<fx-search v-model="value" placeholder="请输入搜索关键词" />
```
...
```html
<fx-search v-model="value" disabled placeholder="请输入搜索关键词" />
```
...
```ts
import type { SearchProps, SearchShape, SearchInstance } from 'fx-mobile-ui';
```
...
```ts
import { ref } from 'vue';
import type { SearchInstance } from 'fx-mobile-ui';
...
| 名称                            | 默认值                       | 描述 |
| ------------------------------- | ---------------------------- | ---- |
| --fx-search-padding            | _10px var(--fx-padding-sm)_ | -    |
| --fx-search-background         | _var(--fx-background-2)_    | -    |
| --fx-search-content-background | _var(--fx-gray-1)_          | -    |
| --fx-search-input-height       | _34px_                       | -    |
| --fx-search-label-padding      | _0 5px_                      | -    |
| --fx-search-label-color        | _var(--fx-text-color)_      | -    |
| --fx-search-label-font-size    | _var(--fx-font-size-md)_    | -    |
| --fx-search-left-icon-color    | _var(--fx-gray-6)_          | -    |
| --fx-search-action-padding     | _0 var(--fx-padding-xs)_    | -    |
| --fx-search-action-text-color  | _var(--fx-text-color)_      | -    |
| --fx-search-action-font-size   | _var(--fx-font-size-md)_    | -    |
