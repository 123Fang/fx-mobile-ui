<!-- html -->
<template>
  <div class="demo-box-icsm-button">
    ...
    <icsm-button
      plain
      icon="https://fastly.jsdelivr.net/npm/@icsmt/assets/user-active.png"
      type="primary"
    >
      按钮
    </icsm-button>
    ...
    <icsm-button color="linear-gradient(to right, #ff6034, #ee0a24)"> 渐变色按钮 </icsm-button>
