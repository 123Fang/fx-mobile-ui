...
import { Picker } from 'fx-mobile-ui';
...
/>
<fx-popup v-model:show="showPicker" destroy-on-close round position="bottom">
  <fx-picker
...
```html
<fx-picker v-model="selectedValues" title="标题" :columns="columns" />
```
...
```html
<fx-picker title="标题" :columns="columns" />
```
...
```html
<fx-picker :columns="columns" :loading="loading" />
```
...
```ts
import { ref } from 'vue';
import type { PickerInstance } from 'fx-mobile-ui';
...
| 名称                                 | 默认值                      | 描述 |
| ------------------------------------ | --------------------------- | ---- |
| --fx-picker-background              | _var(--fx-background-2)_   | -    |
| --fx-picker-toolbar-height          | _44px_                      | -    |
| --fx-picker-title-font-size         | _var(--fx-font-size-lg)_   | -    |
| --fx-picker-title-line-height       | _var(--fx-line-height-md)_ | -    |
| --fx-picker-action-padding          | _0 var(--fx-padding-md)_   | -    |
| --fx-picker-action-font-size        | _var(--fx-font-size-md)_   | -    |
| --fx-picker-confirm-action-color    | _var(--fx-primary-color)_  | -    |
| --fx-picker-cancel-action-color     | _var(--fx-text-color-2)_   | -    |
| --fx-picker-option-padding          | _0 var(--fx-padding-base)_ | -    |
| --fx-picker-option-font-size        | _var(--fx-font-size-lg)_   | -    |
| --fx-picker-option-text-color       | _var(--fx-text-color)_     | -    |
| --fx-picker-option-disabled-opacity | _0.3_                       | -    |
| --fx-picker-mask-color              | _linear-gradient_           | -    |
| --fx-picker-loading-icon-color      | _var(--fx-primary-color)_  | -    |
| --fx-picker-loading-mask-color      | _rgba(255, 255, 255, 0.9)_  | -    |
