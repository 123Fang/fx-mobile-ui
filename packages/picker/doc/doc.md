...
import { Picker } from 'ctf-ics-mobile-ui';
...
/>
<icsm-popup v-model:show="showPicker" destroy-on-close round position="bottom">
  <icsm-picker
...
```html
<icsm-picker v-model="selectedValues" title="标题" :columns="columns" />
```
...
```html
<icsm-picker title="标题" :columns="columns" />
```
...
```html
<icsm-picker :columns="columns" :loading="loading" />
```
...
```ts
import { ref } from 'vue';
import type { PickerInstance } from 'ctf-ics-mobile-ui';
...
| 名称                                 | 默认值                      | 描述 |
| ------------------------------------ | --------------------------- | ---- |
| --icsm-picker-background              | _var(--icsm-background-2)_   | -    |
| --icsm-picker-toolbar-height          | _44px_                      | -    |
| --icsm-picker-title-font-size         | _var(--icsm-font-size-lg)_   | -    |
| --icsm-picker-title-line-height       | _var(--icsm-line-height-md)_ | -    |
| --icsm-picker-action-padding          | _0 var(--icsm-padding-md)_   | -    |
| --icsm-picker-action-font-size        | _var(--icsm-font-size-md)_   | -    |
| --icsm-picker-confirm-action-color    | _var(--icsm-primary-color)_  | -    |
| --icsm-picker-cancel-action-color     | _var(--icsm-text-color-2)_   | -    |
| --icsm-picker-option-padding          | _0 var(--icsm-padding-base)_ | -    |
| --icsm-picker-option-font-size        | _var(--icsm-font-size-lg)_   | -    |
| --icsm-picker-option-text-color       | _var(--icsm-text-color)_     | -    |
| --icsm-picker-option-disabled-opacity | _0.3_                       | -    |
| --icsm-picker-mask-color              | _linear-gradient_           | -    |
| --icsm-picker-loading-icon-color      | _var(--icsm-primary-color)_  | -    |
| --icsm-picker-loading-mask-color      | _rgba(255, 255, 255, 0.9)_  | -    |
